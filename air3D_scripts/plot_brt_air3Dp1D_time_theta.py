...
fig.savefig(os.path.join(root_path, 'aBRS_plot_omega_a_%.2d.png' % omega_index))
scipy.io.savemat(os.path.join(root_path, 'BRT_omega_%.2d.mat' % omega_index), {'model_out': model_out})